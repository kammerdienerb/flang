...
/* hmalloc functions */
char *I8(__hmalloc_fort_alloc)(char *h, __INT_T nelem, dtype kind,
                          size_t len, __STAT_T *stat,
                          char **pointer, __POINT_T *offset, char *base, int check,
                          void *(*mallocfn)(int, size_t));
char *I8(__hmalloc_fort_allocate)(char *h, int nelem, dtype kind,
                             size_t len, char *base,
                             char **pointer, __POINT_T *offset);
char *I8(__hmalloc_fort_local_allocate)(char *h, int nelem,
                                   dtype kind, size_t len, char *base,
                                   char **pointer, __POINT_T *offset);
char *I8(__hmalloc_fort_dealloc)(char *area, __STAT_T *stat, void (*freefn)(void *));
void I8(__hmalloc_fort_deallocate)(char *area);
void I8(__hmalloc_fort_local_deallocate)(char *area);
void *__hmalloc_fort_malloc_without_abort(char *h, size_t n);
void *__hmalloc_fort_calloc_without_abort(char *h, size_t n);
void *__hmalloc_fort_malloc(char *h, size_t n);
void *__hmalloc_fort_realloc(char *h, void *ptr, size_t n);
void *__hmalloc_fort_calloc(char *h, size_t n, size_t s);
void __hmalloc_fort_free(void *ptr);
void *__hmalloc_fort_gmalloc_without_abort(char *h, size_t n);
void *__hmalloc_fort_gcalloc_without_abort(char *h, size_t n);
void *__hmalloc_fort_gmalloc(char *h, size_t n);
void *__hmalloc_fort_grealloc(char *h, void *ptr, size_t n);
void *__hmalloc_fort_gcalloc(char *h, size_t n, size_t s);
void __hmalloc_fort_gfree(void *ptr);
